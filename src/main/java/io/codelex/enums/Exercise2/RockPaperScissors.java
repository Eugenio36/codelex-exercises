    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (playerMove.equals("quit") || playerMove.equals("q")) {
                ...
                System.out.println("I won " + losses + "(" + ((float) (losses * 100 / numOfPlays))
                        + "%). You won " + wins + "(" + ((float) (wins * 100 / numOfPlays)) + "%).");
                System.out.println("Bye!");
                break;
            }

            if (Arrays.stream(Move.values()).noneMatch(x -> x.getMove().equals(playerMove))) {
