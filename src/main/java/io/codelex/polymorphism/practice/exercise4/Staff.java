...
public class Staff {
    ...
    public Staff() {
        ...
        staffList[6] = new Commission("Boris", "Elizabetes 15", "+37129743641",
                "015-25-3647", 6.25, 0.2);
        staffList[7] = new Commission("Eugenio", "Gogoļa 23", "+37129632089",
                "415-26-7426", 9.75, 0.15);
